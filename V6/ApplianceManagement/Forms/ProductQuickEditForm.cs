...
namespace ApplianceManagement.Forms
{
    ...
    ///         TP = RP * ((100 - Disc%) / 100)
    /// RP maps to SalePrice; UnitSalePrice is derived from SalePrice / PackSize.
    /// </summary>
    public class ProductQuickEditForm : Form
    {
        ...
        private void Save()
        {
            ...
            try
            {
                productRepo.Update(product.ProductID, name, tp, rp, product.MinimumStock, product.IsActive);
                product.ProductName = name;
                product.PurchasePrice = tp;
                product.SalePrice = rp;
                Saved = true;
